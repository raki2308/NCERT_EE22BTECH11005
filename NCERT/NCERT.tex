...
\solution \\
Let, event $E$ be such that atleast one letter in its proper envelope.\\
$\implies$ $E'$ is none of the letters in its proper envelope.\\
Let,
\begin{align}
q_i &= wrong \,letter \,in \,envelope \,i\\
\pr{E_1'} &= \pr{q_1}\\
\pr{E_2'} &= \pr{q_2|E_1'}\\
\pr{E_3'} &= \pr{q_3|E_2'}\\
\pr{E'} &= \pr{E_1'}\pr{E_2'}\pr{E_3'}\\
\implies \pr{E'} &= \brak{\frac{2}{3}}
\brak{\frac{1}{2}}\brak{1}\\
&= \frac{1}{3}\\
\implies \pr{E} &= 1-\pr{E'}\\
&= 1-\frac{1}{3}\\
